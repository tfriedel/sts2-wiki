...
public class UndoEndPlayerTurnAction : GameAction
{
	...
	{
		NetUndoEndPlayerTurnAction netUndoEndPlayerTurnAction = default(NetUndoEndPlayerTurnAction);
		netUndoEndPlayerTurnAction.combatRound = _combatRound;
		return netUndoEndPlayerTurnAction;
	}
