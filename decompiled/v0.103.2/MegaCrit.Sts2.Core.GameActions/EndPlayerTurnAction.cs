...
public class EndPlayerTurnAction : GameAction
{
	...
	{
		NetEndPlayerTurnAction netEndPlayerTurnAction = default(NetEndPlayerTurnAction);
		netEndPlayerTurnAction.combatRound = _combatRound;
		return netEndPlayerTurnAction;
	}
