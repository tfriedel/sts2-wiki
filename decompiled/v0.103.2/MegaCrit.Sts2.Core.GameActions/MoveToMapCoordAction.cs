...
public class MoveToMapCoordAction : GameAction
{
	...
	{
		NetMoveToMapCoordAction netMoveToMapCoordAction = default(NetMoveToMapCoordAction);
		netMoveToMapCoordAction.destination = _destination;
		return netMoveToMapCoordAction;
	}
