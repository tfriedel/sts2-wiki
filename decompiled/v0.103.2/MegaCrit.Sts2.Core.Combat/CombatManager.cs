...
public class CombatManager
{
	...
	[CompilerGenerated]
	private struct _003CWaitUntilQueueIsEmptyOrWaitingOnNonPlayerDrivenAction_003Ed__117 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				{
					_003C_003E8__1.completionSource = new TaskCompletionSource();
					RunManager.Instance.ActionExecutor.AfterActionExecuted += AfterActionExecuted;
					awaiter = _003C_003E8__1.completionSource.Task.GetAwaiter();
			...
			void AfterActionExecuted(GameAction action)
			{
				...
				{
					((_003C_003Ec__DisplayClass117_0)(object)this).completionSource.SetResult();
				}
			}
		}
	...
	public async Task StartCombatInternal()
	{
		...
		else
		{
			...
			NModalContainer.Instance?.Add((Node)(object)ftue, showBackstop: false);
		}
	...
	private async Task StartTurn(Func<Task>? actionDuringEnemyTurn = null)
	{
		...
		if (state3 != null && state3.CurrentSide == CombatSide.Player)
		{
			...
			{
				((Node)(object)NCombatRoom.Instance)?.AddChildSafely((Node?)(object)NPlayerTurnBanner.Create(_state.RoundNumber));
			}
		...
		{
			((Node)(object)NCombatRoom.Instance)?.AddChildSafely((Node?)(object)NEnemyTurnBanner.Create());
		}
	...
	[AsyncStateMachine(typeof(_003CWaitUntilQueueIsEmptyOrWaitingOnNonPlayerDrivenAction_003Ed__117))]
	private Task WaitUntilQueueIsEmptyOrWaitingOnNonPlayerDrivenAction()
	{
