...
public abstract class EpochModel
{
	...
	public Texture2D Portrait => ResourceLoader.Load<Texture2D>(PackedPortraitPath, (string)null, (CacheMode)1);

	public string PackedPortraitPath => ImageHelper.GetImagePath("atlases/epoch_atlas.sprites/" + Id.ToLowerInvariant() + ".tres");

	public Texture2D BigPortrait => ResourceLoader.Load<Texture2D>(BigPortraitPath, (string)null, (CacheMode)1);
