...
internal class MegaCritSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SettingsSaveMod> jsonTypeInfo))
		{
			JsonObjectInfoValues<SettingsSaveMod> objectInfo = new JsonObjectInfoValues<SettingsSaveMod>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SettingsSaveModPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<BadgeStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => BadgeStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableBadge> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableBadgePropInit(options2);
