...
internal class GameInfoUploaderSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<AncientChoiceInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => AncientChoiceInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CardInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => CardInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<DailyMods> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => DailyModsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EnchantmentInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => EnchantmentInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EncounterInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => EncounterInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<MegaCrit.Sts2.GameInfo.Objects.EventInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => EventInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<IGameInfo> jsonTypeInfo))
		{
			JsonObjectInfoValues<IGameInfo> objectInfo = new JsonObjectInfoValues<IGameInfo>
			{
				ObjectCreator = null,
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => IGameInfoPropInit(options2),
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<Keywords> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => KeywordsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<NeowBonusInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => NeowBonusInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<PotionInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => PotionInfoPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<RelicInfo> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => RelicInfoPropInit(options2);
