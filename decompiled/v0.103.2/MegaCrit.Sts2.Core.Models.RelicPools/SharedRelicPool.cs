...
public sealed class SharedRelicPool : RelicPoolModel
{
	...
	public override IEnumerable<RelicModel> GetUnlockedRelics(UnlockState unlockState)
	{
		...
		if (!unlockState.IsEpochRevealed<Relic1Epoch>())
		{
			...
			{
				RelicModel r6 = r;
				return Relic1Epoch.Relics.Any((RelicModel relic) => relic.Id == r6.Id);
			});
		}
		if (!unlockState.IsEpochRevealed<Relic2Epoch>())
		{
			...
			{
				RelicModel r5 = r;
				return Relic2Epoch.Relics.Any((RelicModel relic) => relic.Id == r5.Id);
			});
		}
		if (!unlockState.IsEpochRevealed<Relic3Epoch>())
		{
			...
			{
				RelicModel r4 = r;
				return Relic3Epoch.Relics.Any((RelicModel relic) => relic.Id == r4.Id);
			});
		}
		if (!unlockState.IsEpochRevealed<Relic4Epoch>())
		{
			...
			{
				RelicModel r3 = r;
				return Relic4Epoch.Relics.Any((RelicModel relic) => relic.Id == r3.Id);
			});
		}
		if (!unlockState.IsEpochRevealed<Relic5Epoch>())
		{
			...
			{
				RelicModel r2 = r;
				return Relic5Epoch.Relics.Any((RelicModel relic) => relic.Id == r2.Id);
			});
		}
		return list;
	}
