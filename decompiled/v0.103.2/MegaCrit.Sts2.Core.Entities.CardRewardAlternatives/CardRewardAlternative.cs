...
public class CardRewardAlternative
{
	...
	public CardRewardAlternative(string optionId, Func<Task> onSelect, PostAlternateCardRewardAction afterSelected)
	{
		...
		Hotkey = StringName.op_Implicit((afterSelected == PostAlternateCardRewardAction.DismissScreenAndKeepReward) ? MegaInput.cancel : MegaInput.viewExhaustPileAndTabRight);
	}
