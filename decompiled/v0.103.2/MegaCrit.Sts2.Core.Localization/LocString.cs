...
{
	[CompilerGenerated]
	private string _003ClocTable_003EP;

	[CompilerGenerated]
	private string _003ClocEntryKey_003EP;

	[JsonIgnore]
	private readonly Dictionary<string, object> _variables;

	[JsonPropertyName("table")]
	public string LocTable => _003ClocTable_003EP;

	[JsonPropertyName("key")]
	public string LocEntryKey => _003ClocEntryKey_003EP;
	...
	public LocString(string locTable, string locEntryKey)
	{
		_003ClocTable_003EP = locTable;
		_003ClocEntryKey_003EP = locEntryKey;
	...
	{
		if (_003ClocTable_003EP != other?.LocTable)
		{
