...
public sealed class MerchantRelicEntry : MerchantEntry
{
	...
	{
		IEnumerable<RelicModel> blacklist2 = blacklist;
		SetModel(RelicFactory.PullNextRelicFromBack(_player, rarity, (RelicModel r) => (blacklist2 == null || !blacklist2.Contains(r)) && r.IsAllowedInShops).ToMutable());
	}
