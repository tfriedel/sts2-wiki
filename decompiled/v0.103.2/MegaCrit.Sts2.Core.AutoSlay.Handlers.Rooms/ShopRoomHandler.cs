...
public class ShopRoomHandler : IRoomHandler, IHandler
{
	...
	public async Task HandleAsync(Rng random, CancellationToken ct)
	{
		...
		NMerchantRoom room = await WaitHelper.ForNode<NMerchantRoom>(root, "/root/Game/RootSceneContainer/Run/RoomContainer/MerchantRoom", ct, (TimeSpan?)null);
		...
		NBackButton nBackButton = UiHelper.FindFirst<NBackButton>((Node)(object)room);
		if (nBackButton != null)
		{
