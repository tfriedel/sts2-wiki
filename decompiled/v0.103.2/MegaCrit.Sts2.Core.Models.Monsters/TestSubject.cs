...
public sealed class TestSubject : MonsterModel
{
	...
	{
		SetColor(Colors.White);
		((Node)(object)NCombatRoom.Instance.BackCombatVfxContainer).AddChildSafely((Node?)(object)NTestSubjectBurnVfx.Create());
	...
	private void SetColor(Color color)
	{
		...
		if (nCreature != null)
		{
			...
			if (specialNode != null)
			{
				((CanvasItem)specialNode).SetSelfModulate(color);
			}
		}
	}
