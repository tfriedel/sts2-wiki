...
public static class ModelIdSerializationCache
{
	...
	public static void Init()
	{
		...
		foreach (Type item7 in list2)
		{
			...
			xxHash.Append(MemoryExtensions.AsSpan(array, 0, bytes));
		...
		foreach (string allEpochId in EpochModel.AllEpochIds)
		{
			...
			xxHash.Append(MemoryExtensions.AsSpan(array, 0, bytes2));
		}
		...
		BinaryPrimitives.WriteInt32LittleEndian(MemoryExtensions.AsSpan(array), MaxCategoryId);
		xxHash.Append(MemoryExtensions.AsSpan(array, 0, 4));
		BinaryPrimitives.WriteInt32LittleEndian(MemoryExtensions.AsSpan(array), MaxEntryId);
		xxHash.Append(MemoryExtensions.AsSpan(array, 0, 4));
		BinaryPrimitives.WriteInt32LittleEndian(MemoryExtensions.AsSpan(array), MaxEpochId);
		xxHash.Append(MemoryExtensions.AsSpan(array, 0, 4));
