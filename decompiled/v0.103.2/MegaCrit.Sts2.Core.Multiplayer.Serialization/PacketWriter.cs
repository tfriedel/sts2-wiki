...
public class PacketWriter
{
	...
	{
		ResizeBufferIfNecessary(bits);
		BinaryPrimitives.WriteInt16LittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
		BitSerializationUtil.WriteBytes(_tempBuffer, Buffer, BitPosition, bits);
		BitPosition += bits;
	}
	...
	{
		ResizeBufferIfNecessary(bits);
		BinaryPrimitives.WriteUInt16LittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
		BitSerializationUtil.WriteBytes(_tempBuffer, Buffer, BitPosition, bits);
		BitPosition += bits;
	}
	...
	{
		ResizeBufferIfNecessary(bits);
		BinaryPrimitives.WriteInt32LittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
		BitSerializationUtil.WriteBytes(_tempBuffer, Buffer, BitPosition, bits);
		BitPosition += bits;
	}
	...
	{
		ResizeBufferIfNecessary(bits);
		BinaryPrimitives.WriteUInt32LittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
		BitSerializationUtil.WriteBytes(_tempBuffer, Buffer, BitPosition, bits);
		BitPosition += bits;
	}
	...
	public void WriteFloat(float val, QuantizeParams? quantizeParams = null)
	{
		...
		else
		{
			...
			BinaryPrimitives.WriteSingleLittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
	...
	public void WriteLong(long val, int bits = 64)
	{
		...
		BinaryPrimitives.WriteInt64LittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
		BitSerializationUtil.WriteBytes(_tempBuffer, Buffer, BitPosition, bits);
		BitPosition += bits;
	}
	...
	{
		ResizeBufferIfNecessary(64);
		BinaryPrimitives.WriteUInt64LittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
		BitSerializationUtil.WriteBytes(_tempBuffer, Buffer, BitPosition, bits);
		BitPosition += bits;
	}
	...
	{
		ResizeBufferIfNecessary(64);
		BinaryPrimitives.WriteDoubleLittleEndian(MemoryExtensions.AsSpan(_tempBuffer), val);
