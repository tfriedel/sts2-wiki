...
public class PacketReader
{
	...
	public short ReadShort(int bits = 16)
	{
		...
		BitSerializationUtil.ReadBits(Buffer, BitPosition, _tempBuffer, bits);
		BitPosition += bits;
		return BinaryPrimitives.ReadInt16LittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public ushort ReadUShort(int bits = 16)
	{
		...
		BitSerializationUtil.ReadBits(Buffer, BitPosition, _tempBuffer, bits);
		BitPosition += bits;
		return BinaryPrimitives.ReadUInt16LittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public int ReadInt(int bits = 32)
	{
		...
		BitSerializationUtil.ReadBits(Buffer, BitPosition, _tempBuffer, bits);
		BitPosition += bits;
		return BinaryPrimitives.ReadInt32LittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public uint ReadUInt(int bits = 32)
	{
		...
		BitSerializationUtil.ReadBits(Buffer, BitPosition, _tempBuffer, bits);
		BitPosition += bits;
		return BinaryPrimitives.ReadUInt32LittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public float ReadFloat(QuantizeParams? quantizeParams = null)
	{
		...
		BitPosition += 32;
		return BinaryPrimitives.ReadSingleLittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public long ReadLong(int bits = 64)
	{
		...
		BitSerializationUtil.ReadBits(Buffer, BitPosition, _tempBuffer, bits);
		BitPosition += bits;
		return BinaryPrimitives.ReadInt64LittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public ulong ReadULong(int bits = 64)
	{
		...
		BitSerializationUtil.ReadBits(Buffer, BitPosition, _tempBuffer, bits);
		BitPosition += bits;
		return BinaryPrimitives.ReadUInt64LittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}
	...
	public double ReadDouble()
	{
		...
		BitPosition += 64;
		return BinaryPrimitives.ReadDoubleLittleEndian(MemoryExtensions.AsSpan(_tempBuffer));
	}

	public Vector2 ReadVector2(QuantizeParams? quantizeParamsX = null, QuantizeParams? quantizeParamsY = null)
	{
		//IL_0012: Unknown result type (might be due to invalid IL or missing references)
		float num = ReadFloat(quantizeParamsX);
		float num2 = ReadFloat(quantizeParamsY);
